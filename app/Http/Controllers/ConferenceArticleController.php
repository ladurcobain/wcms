...
class ConferenceArticleController extends Controller
{
    ...
    private $subtitle = "Artikel";
    private $acc_menu = 44;
    private $news_category = "Artikel";
            ...
            if($access != "[]") {
                if (in_array($this->acc_menu, $access)) {
                    ...
                    if($res->status == true) {
                        ...
                        return view('conference.article.index', $data, compact('info', 'results'));
                    }
                    else {
                        return redirect('/');  
                    }    
        ...
        if($access != "[]") {
            if (in_array($this->acc_menu, $access)) {
                ...
                if($res->status == true) {
                    ...
                    return view('conference.article.read', $data, compact('info'));
                }
                else {
                    return redirect('/');  
                }    
