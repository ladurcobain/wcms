...
class AboutDoctrinController extends Controller
{
    private $title = "Tentang Kami";
    private $subtitle = "Doktrin Adyaksa";
    private $acc_menu = 22;
            ...
            if($access != "[]") {
                if (in_array($this->acc_menu, $access)) {
                    ...
                    if($res->status == true) {
                        ...
                        return view('about.doctrin', $data, compact('info'));
                    }
                    else {
                        return redirect('/');  
                    }  
