...
class InformationDpoController extends Controller
{
    ...
    private $subtitle = "Daftar Pencarian Orang";
    private $acc_menu = 34;
        ...
        if($slug != "") {
            ...
            if($access != "[]") {
                if (in_array($this->acc_menu, $access)) {
                    ...
                    $uri = Curl::endpoint();
                    $url = $uri .'/'.'v1/get-information-dpo';
                    $param = array(
                    ...
                    if($res->status == true) {
                        ...
                        return view('information.dpo.index', $data, compact('info', 'results'));
                    }
                    else {
                        return redirect('/');  
                    }   
    ...
    public function read($id="")
    {
        ...
        if($access != "[]") {
            if (in_array($this->acc_menu, $access)) {
                if($id != "") {
                    $uri = Curl::endpoint();
                    $url = $uri .'/'.'v1/read-information-dpo/'. $slug .'/@'. $id .'&more';
                ...
                if($res->status == true) {
                    ...
                    return view('information.dpo.read', $data, compact('info'));
                }
                else {
                    return redirect('/');  
                }    
