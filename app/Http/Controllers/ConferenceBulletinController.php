...
class ConferenceBulletinController extends Controller
{
    private $title = "Siaran Pers";
    private $subtitle = "Siaran Pers";
    private $acc_menu = 45;
    private $news_category = "Siaran Pers";
            ...
            if($access != "[]") {
                if (in_array($this->acc_menu, $access)) {
                    ...
                    if($res->status == true) {
                        ...
                        return view('conference.bulletin.index', $data, compact('info', 'results'));
                    }
                    else {
                        return redirect('/');  
                    }    
        ...
        if($access != "[]") {
            if (in_array($this->acc_menu, $access)) {
                ...
                if($res->status == true) {
                    ...
                    return view('conference.bulletin.read', $data, compact('info'));
                }
                else {
                    return redirect('/');  
                }    
