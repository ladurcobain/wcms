        ...
        if($slug != "") {
            ...
            if($access != "[]") {
                if (in_array($this->acc_menu, $access)) {
                    ...
                    $uri = Curl::endpoint();
                    $url = $uri .'/'.'v1/get-information-infrastructure';
                    $param = array(
                    ...
                    if($res->status == true) {
                        ...
                        return view('information.infrastructure.index', $data, compact('info', 'results'));
                    }
                    else {
                        return redirect('/');  
                    }   
        ...
        if($slug != "") {
            ...
            if($access != "[]") {
                if (in_array($this->acc_menu, $access)) {
                    if($id != "") {
                        $uri = Curl::endpoint();
                        $url = $uri .'/'.'v1/read-information-infrastructure/'. $slug .'/@'. $id .'&more';
                    ...
                    if($res->status == true) {
                        ...
                        return view('information.infrastructure.read', $data, compact('info'));
                    }
                    else {
                        return redirect('/');  
                    }
