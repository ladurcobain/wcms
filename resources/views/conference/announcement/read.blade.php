        ...
        <div class="container mt-4">
            ...
            <div class="row">
                                ...
                                <div class="post-block mt-5 post-share">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <button type="button" id="btn-play" onclick="speak();"
                                                class="btn btn-primary"><i class="fas fa-play"></i>
                                                <?php echo Session::get('flag') == 'uk' ? 'Play' : 'Putar'; ?></button>
                                            <button type="button" id="btn-stop" onclick="stops();"
                                                class="d-none btn btn-danger"><i class="fas fa-stop"></i>
                                                <?php echo Session::get('flag') == 'uk' ? 'Stop' : 'Berhenti'; ?></button>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <div>
                                                <ul class="social-icons social-icons-medium">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo $read->link_youtube; ?>" target="_blank"
                                                            data-bs-toggle="tooltip" data-bs-animation="false"
                                                            data-bs-placement="top" title="<?php echo $read->link_youtube; ?>">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo $read->link_instagram; ?>" target="_blank"
                                                            data-bs-toggle="tooltip" data-bs-animation="false"
                                                            data-bs-placement="top" title="<?php echo $read->link_instagram; ?>">
                ...
                <?php if(!empty($headline)) {?>
                    ...
                    <br />
                    <?php } ?>
                    <h3 class="font-weight-bold text-3 mb-0 pb-2"><?php echo Session::get('flag') == 'uk' ? 'Other Announcement' : 'Pengumuman Lainnya'; ?></h3>
                    <div class="pb-1 card card-body">
                        <div class="mb-2 pb-1">
                            ...
                            <article class="thumb-info thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                                <div class="row align-items-center pb-1">
                                    <div class="col-sm-4">
                                        <div class="post-image mb-2">
                                            <div class="img-thumbnail img-thumbnail-no-borders d-block">
                                                <a href="<?php echo url('conference/announcement/' . $rOther->id . '/read'); ?>">
