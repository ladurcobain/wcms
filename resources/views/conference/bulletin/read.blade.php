        ...
        <div class="container mt-4">
            ...
            <div class="row">
                ...
                <?php if(!empty($headline)) {?>
                    ...
                    <br />
                    <?php } ?>
                    <h3 class="font-weight-bold text-3 mb-0 pb-2"><?php echo Session::get('flag') == 'uk' ? 'Other Bulletin' : 'Siaran Pers Lainnya'; ?></h3>
                    <div class="pb-1 card card-body">
                        <div class="mb-2 pb-1">
                                ...
                                <div class="row align-items-center pb-1">
                                    <div class="col-sm-12">
                                        <div class="post-info">
                                            <h4
                                                class="d-block pb-1 line-height-2 text-3 text-dark font-weight-semibold mb-0">
                                                <a href="<?php echo url('conference/bulletin/' . $rOther->id . '/read'); ?>"
