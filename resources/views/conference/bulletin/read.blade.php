                        ...
                        <article class="thumb-info thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                            <div class="row align-items-center pb-1">
                                <div class="col-sm-12">
                                    <div class="post-info">
                                        <h4 class="d-block pb-1 line-height-2 text-3 text-dark font-weight-semibold mb-0">
                                            <a href="<?php echo url('conference/bulletin/'. $rOther->id.'/read'); ?>" class="text-decoration-none text-color-dark text-color-hover-primary"><?php echo Status::str_ellipsis($rOther->title, 100); ?></a>
                                        </h4>
                                        <div class="post-meta">
