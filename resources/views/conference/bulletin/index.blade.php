                            ...
                            <div class="col-lg-12">
                                <div class="post-content bg-color-light">
                                    <h2 class="font-weight-bold text-4 line-height-3 mt-0 mb-2">
                                        <a href="<?php echo url('conference/bulletin/'. $row->id.'/read'); ?>"><?php echo $row->title; ?></a>
                                    </h2>
                                    ...
                                    <div class="post-meta m-0 p-0">
                                        <span class="d-block mt-2">
                                            <a href="<?php echo url('conference/bulletin/'. $row->id.'/read'); ?>" class="btn btn-xs btn-light text-1 text-uppercase">
