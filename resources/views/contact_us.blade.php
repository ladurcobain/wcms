    ...
    <div class="container py-5 my-5">
        <div class="row card card-body transition-3ms">
            <div class="col-lg-12">
                ...
                <form style="color: black;" id="contactusForm" class="contact-form-recaptcha-v3"
                    action="<?php echo url('ajax/set-contactus'); ?>" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    <input type="hidden" name="slug" value="{{ $slug }}" />
                    <div class="row">
                        <div class="form-group col-lg-6">
                            <label class="form-label mb-1 text-2"><?php echo Session::get('flag') == 'uk' ? 'Name' : 'Nama'; ?> <span
                            ...
                            <input type="text" value="" data-msg-required="<?php echo Session::get('flag') == 'uk' ? 'Please enter your name' : 'Silahan masukkan nama lengkap'; ?>." maxlength="100"
                                class="form-control text-3 h-auto py-2" id="name" name="name" autocomplete="off"
                                required />
                        </div>
                        <div class="form-group col-lg-6">
                            <label class="form-label mb-1 text-2"><?php echo Session::get('flag') == 'uk' ? 'Email' : 'Alamat Surel'; ?> <span
                                    class="text-danger">*</span></label>
                            <input type="email" value="" data-msg-required="<?php echo Session::get('flag') == 'uk' ? 'Please enter your email address' : 'Silahan masukkan alamat email'; ?>."
                                ...
                                class="form-control text-3 h-auto py-2" id="email" name="email" autocomplete="off"
                                required />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                            <label class="form-label mb-1 text-2"><?php echo Session::get('flag') == 'uk' ? 'Subject' : 'Subjek'; ?> <span
                                    class="text-danger">*</span></label>
                            <input type="text" value="" data-msg-required="<?php echo Session::get('flag') == 'uk' ? 'Please enter the subject' : 'Silahan masukkan subyek pesan'; ?>." maxlength="100"
                                class="form-control text-3 h-auto py-2" id="subject" name="subject" autocomplete="off"
                                required />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                            <label class="form-label mb-1 text-2"><?php echo Session::get('flag') == 'uk' ? 'Message' : 'Pesan'; ?> <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <button data-loading-text="Loading ..." class="btn btn-primary btn-modern" id="contactusButton"
                                type="submit"><strong>Kirim!</strong></button>
                        </div>
                    </div>
                </form>
            </div>
...
?>
    <div class="mapouter">
        <div class="gmap_canvas">
            <iframe width="100%" height="500" id="gmap_canvas" src="<?php echo $map; ?>" frameborder="0" scrolling="no"
