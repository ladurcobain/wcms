                ...
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $row->title }}</td>
                            <td align="center">    
                                <button type="button" OnClick="link_new_tab('<?php echo $row->path;  ?>');" class="btn btn-sm btn-info"><i class="fas fa-download"></i> Unduh</button>
                            </td>
                        </tr>
                        <?php } ?>
                        <?php } else { ?>
                    ...
                    <tfoot>    
                        <tr>
                            ...
                            <td><span style="margin-top: 15px;float:right;">{{ $results->onEachSide(1)->links() }}</span></td>
                        </tr>
                    </tfoot>
                    <?php } ?>
                </table>
